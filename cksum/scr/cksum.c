/*
**  cksum.c - Compute the Posix.2 Unix CRC IEEE 1003.2 - 1992 checksum of a file
**
**  public domain by Vanderson Pimenta
**
**  Oct/2018
*/
 ...
 * the file contents.
 */
void calc_file_cksum(char *fname) 
{
 register FILE *fp;
